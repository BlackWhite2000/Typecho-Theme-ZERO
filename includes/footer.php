...
<div class="container">
  <div class="footer-height-50px"></div>
                <section class="footer-float-left footer-align-center">
                	<?php if (($this->options->build_time) == ''): ?><p>Copyright © <?php echo date('Y '); ?><?php else: ?><p>Copyright © <?php $this->options->build_time(); ?>-<?php echo date('Y '); ?><?php endif; ?> <a href="#" target=_self>BlackWhite</a></p>
